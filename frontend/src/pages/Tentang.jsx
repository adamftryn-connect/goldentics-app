      ...
      <div className="dark-section">
        <div className="wrap2">
          ...
          <div className="stack-grid">
            ...
            <div className="stack-item"><div className="stack-icon"><img className="icon-img" src={iconRecharts} alt="" aria-hidden="true" /></div><div><div className="stack-name">Line Chart</div><div className="stack-role">Visualisasi Data Interaktif</div></div></div>
